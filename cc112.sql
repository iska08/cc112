...
INSERT INTO `lokasi` (`id`, `lat_long`, `alamat`, `desa`, `kec`, `kejadian`, `tanggal_terima`, `tanggal_selesai`, `approve`, `ket`, `laporan`, `tim`, `jumlah_tim`, `nama_pelapor`, `noTelp_pelapor`, `bulan`, `tahun`) VALUES
