  ...
  <div class="col-12">
    <div class="card card-info card-outline">
      <div class="card-header">
        <h5 class="card-title">
          Data Darurat Call Center 112 kab. Sumenep
          ...
          <div class="col-md-12"> <!-- ukuruan layar dengan bootstrap adalah 12 kolom, bagian kiri dibuat sebesar 4 kolom-->
            <div class="table-responsive">
              <table id="data_kej" class="table table-bordered">
                ...
                <tbody>
                  <?php
                  if($_GET['bulan'] || $_GET['th'] || $_GET['kej']){
                    $bulan = $_GET['bulan'];
                    $tahun = $_GET['th'];
                    $kej = $_GET['kej'];
                ...
                <tr>
                  ...
                  <td colspan="2" align="center">
                    <a target="blank" href="data_kejadian_pdf.php?<?php if($_GET['bulan'] && $_GET['th'] && $_GET['kej']){ echo "bulan=" .$_GET['bulan']; echo "&th=" .$_GET['th']; echo "&kej=" .$_GET['kej'];} ?>"  aria-label="pdf" style="color:red;">
