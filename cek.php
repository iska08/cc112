...
.mobile-space {margin-top:50px;}
.mobile-space_1 {margin-top:50px;}
.logo{height:40px; }
.gbr{width:50%;height: 50%; }
.chart {  width: 100%; min-height: 300px; }
}
 @media screen and (max-width: 600px) {
.mobile-space {margin-top:30px;}
.mobile-space_1 {margin-top:0px;}
.logo { height:30px; }
.gbr{width:100%; }
}
 @media screen and (max-width: 1000px) {
...
<div class="fixed-top container" style="background-color: #fff;">
    ...
    <center><a href="https://ekominfo.sumenepkab.go.id/cc112/"><img src="img/cc112_ok.jpg"   class="img-fluid"></a></center>   
...
<script>
       ...
       var call_center = new LeafIcon({iconUrl: '112.png'});  
        ...
        L.marker([<?php echo str_replace(['[', ']', 'LatLng', '(', ')'], '', $hasil['lat_long']); ?>],{icon: call_center}).addTo(mymap)
...
<?php include 'footer.php';?>
        ...
        <script type="text/javascript">
            ...
            $hasil_1 = mysqli_num_rows($tampil_1);?> <?php if($hasil_1){echo $hasil_1;}else{echo "0";} ?> <?php echo ",";?><?php } ?>],<?php } ?>    
...
<script>
 $(document).ready(function() {
            ...
            //simpan 
            $("#survey").on("submit", "#form_input_survey", function(e) {
                e.preventDefault();
                $.ajax({
