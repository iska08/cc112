    ...
    <div class="col-md-12">
        ...
        <table id="survey" class="table table-bordered">
            ...
            <tbody>
                <?php
                $noo=1;
                $tampil_survey = mysqli_query($kominfo, "select * from survey"); //ambil data dari tabel lokasi
                ...
                ?>
                    <tr>
                        ...
                        <td width="5%">
                            <div class="btn-group">
                                <a id="hapus" value="<?php echo $hasil_survey['id']; ?>" class="btn btn-danger btn-sm hapus">Hapus</a>
                            </div>
                        </td>
                    </tr>
                <?php
            ...
            <tr>
                ...
                <td colspan="2" align="center"><a target="blank" href="data_survey_pdf.php" aria-label="pdf" style="color:red;"><i class="far fa-file-pdf"></i></i></a></td>
            </tr>
        </table>
    </div>
</div>
