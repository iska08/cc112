    ...
    <body>
        <div class="container">
            <div class="mb-5 border-bottom">
                <center>
                    <img src="http://112.sumenepkab.go.id/img/cc112_ok.jpg" class="img-fluid">
                    <br />
                ...
                <div id="smartwizard">
                    ...
                    <div class="tab-content">
                        <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">ON</div>
                        <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2">ON</div>
                        <div id="step-3" class="tab-pane" role="tabpanel" aria-labelledby="step-3">ON</div>
                    </div>
                    <div class="progress">
