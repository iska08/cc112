    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <form method="post" id="<?php if($id_kec){?>form_edit_kec<?php }else{?>form_tambah_kec<?php } ?>">
                <?php $tampil_id_kec = mysqli_query($kominfo, "select * from kecamatan where id='$id_kec' "); //ambil data dari tabel lokasi
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_kecamatan"
                        value="<?php echo $hasil_id_kec['nama_kecamatan']; ?>" required>
                </div>
                <div class="form-group">
                    <?php if($id_kec){ ?>
        ...
        <div class="col-md-8">
            ...
            <table id="kec" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <?php $no=1; $tampil_kec = mysqli_query($kominfo, "select * from kecamatan order by id desc"); //ambil data dari tabel lokasi
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $hasil_kec['nama_kecamatan']; ?>
                        </td>
                        <td width="5%">
                            <div class="btn-group">
                                <a id="edit_kec" value="<?php echo $hasil_kec['id']; ?>"
                                    class="btn btn-info btn-sm btn-sm">Edit</a>
                                <a id="hapus_kec" value="<?php echo $hasil_kec['id']; ?>"
