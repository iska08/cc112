...
?><link rel="stylesheet"href="assets/css/MarkerCluster.css"/><link rel="stylesheet"href="assets/css/MarkerCluster.Default.css"/><script src="assets/js/leaflet.markercluster-src.js"></script><link href='css/leaflet.fullscreen.css'rel='stylesheet'/><script src='js/Leaflet.fullscreen.min.js'></script><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script><script type="text/javascript"src="https://www.gstatic.com/charts/loader.js"></script><div class="card card-primary card-outline"><div class="card-header "><h5 class="card-title">Peta Lokasi Kejadian</h5></div><div class="card-body "><div id="mapid"style="width: 100%; height: 600px;"></div><script> //setting maps menggunakan api mapbox bukan google maps, daftar dan dapatkan token  
...
<?php $tampil=mysqli_query($kominfo, "select * from lokasi  "); //ambil data dari tabel lokasi
...
?></script><br/><div class="row"><div class="col-md-12"><div class="card card-primary card-outline"><div class="card-header"><h3 class="card-title"><i class="far fa-chart-bar"></i>Grafik Kejadian </h3><div class="card-tools"><button type="button"class="btn btn-tool"data-card-widget="collapse"><i class="fas fa-minus"></i></button><button type="button"class="btn btn-tool"data-card-widget="remove"><i class="fas fa-times"></i></button></div></div><div class="card-body"><div style="width: 100%; height: 100%;"id="chart_div1"class="chart"></div></div></div><div class="row"><div class="col-md-12"><div class="card card-primary card-outline"><div class="card-header"><h3 class="card-title"><i class="far fa-chart-bar"></i>Chart Kejadian </h3><div class="card-tools"><button type="button"class="btn btn-tool"data-card-widget="collapse"><i class="fas fa-minus"></i></button><button type="button"class="btn btn-tool"data-card-widget="remove"><i class="fas fa-times"></i></button></div></div><div class="card-body"><div id="piechart"></div></div></div></div></div><script type="text/javascript">$(window).resize(function() {
    drawChart();
  }
...
function drawChart1() {
  var data=google.visualization.arrayToDataTable([ ['tahun', <?php $tampil=mysqli_query($kominfo, "select * from lokasi GROUP BY kejadian "); //ambil data dari tabel lokasi
    ...
    while($hasil=mysqli_fetch_array($tampil)) {
      $nama_kej=$hasil['kejadian']; $tampil_1=mysqli_query($kominfo, "select * from lokasi where kejadian='$nama_kej' "); //ambil data dari tabel lokasi
      $hasil_1=mysqli_num_rows($tampil_1); ?> <?php echo $hasil_1; ?> <?php echo ","; ?><?php
    }
